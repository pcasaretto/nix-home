  ...
  systemInfoPage = pkgs.writeTextFile {
    ...
    text = ''
      ...
      <body>
        <div class="container">
          ...
          <div class="card">
            ...
            <div class="info-box">
              ...
              <p>
                Services are automatically registered! To add a new service:
              </p>
              <ol style="margin-left: 1.5rem; margin-top: 0.5rem; line-height: 1.8;">
                <li>Create <code>services/&lt;name&gt;.nix</code> with nginx config</li>
                <li>Register the service with <code>services.cyberspace.registeredServices</code></li>
                <li>Import in <code>services/default.nix</code></li>
                <li>Rebuild - it appears here automatically! ✨</li>
              </ol>
              <p style="margin-top: 0.5rem;">
                See <code>README.md</code> for examples and templates.
              </p>
            </div>
          </div>

          <div class="footer">
            <p>Powered by NixOS + nginx + Tailscale</p>
        ...
        <script>
          // Fetch dynamic system information
          async function updateSystemInfo() {
            try {
              ...
              console.log('System info API not available, using static values');
              document.getElementById('tailscale-ip').textContent = 'Use: tailscale ip -4';
              document.getElementById('uptime').textContent = 'N/A';
              document.getElementById('tailscale-ip').classList.remove('loading');
              document.getElementById('uptime').classList.remove('loading');
...
in
{
  services.nginx.virtualHosts."cyberspace" = {
    default = true;  # This will be the default virtualHost instead of the 404
    listen = [
    ...
    # Optional: API endpoint for dynamic system info
    # This can be implemented later with a simple service
    locations."/api/system-info" = {
      return = "404";
      extraConfig = ''
        # Placeholder for future dynamic system info service
        # You can add a small backend service here later
      '';
    };
  };
}
