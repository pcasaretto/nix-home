...
Block diagrams provide precise control over layout and positioning, unlike flowcharts which use automatic layout.
...
block-beta
    ...
    server1[("Server 1")] server2[("Server 2")] space server3[("Server 3")] server4[("Server 4")]
