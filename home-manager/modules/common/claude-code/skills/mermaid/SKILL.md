...
1. **Identify diagram type** - Match the user's need to the appropriate diagram type
...
5. **Consider direction** - `TD` (top-down) for hierarchies, `LR` (left-right) for processes
